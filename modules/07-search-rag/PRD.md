# Search RAG — Ask My/Team/Both — PRD

## What it does
Titan embed + Claude RAG, cite card_id, Request Access flow, client_name PRIMARY filter
...
## User Story
As a user with Client=Acme, Project=Apollo-123, I want search rag — ask my/team/both so I can get cards without scanning whole mailbox.
