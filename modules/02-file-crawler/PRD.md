# File Crawler — SharePoint Subfolders Iteration — PRD

## What it does
Breadth-first crawl depth<4 <1000 files, filter modified last 30d + OPP/Project keywords, link+date+author only
...
## User Story
As a user with Client=Acme, Project=Apollo-123, I want file crawler — sharepoint subfolders iteration so I can get cards without scanning whole mailbox.
