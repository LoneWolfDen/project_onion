...
Steps:
1. Anchor: Select Client Acme UK, create ProjectRef Acme Discovery, add OpportunityID O-5030460, ConnectedRecord 006Uj00000QOBkvIAH, SharePoint acmespf, GDP 8399 — multi-multi link table validation Relevant? Yes/No/Edit
...
Success criteria: One card shows Acme Discovery O-5030460 / 006Uj... with timeline strip Week 33: Laptop 50%->100% [Row12+Row18] and freshness 2d ago green — both IDs searchable
...
- Multi-multi: One OpportunityID O-5030460 may link to many ConnectedRecords 006Uj... (extensions), many ProjectIDs, many GDP IDs 8399, many SMPs acmespf — ProjectRef Acme Discovery anchors all
