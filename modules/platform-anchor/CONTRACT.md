...
Inputs:
- client_name: PRIMARY FILTER Acme UK
- project_ref_name: logical grouping Acme Discovery
...
- sharepoint_smps: array url — acmespf

Outputs:
- anchor_id: hash(client_name + project_ref_name)
- link_table: {opportunity_numbers:[O-5030460], connected_record_ids:[006Uj...], project_ids:[], gdp_ids:[8399], sharepoint_smps:[acmespf]} — many-many — One O-5030460 may have many ConnectedRecords extensions, many ProjectIDs team groups, many GDPs

Rule: When scan finds new ConnectedRecord 006Uj... linked to same SharePoint acmespf with same O-5030460 base — ask Relevant? Yes/No/Edit — add to ProjectRef
