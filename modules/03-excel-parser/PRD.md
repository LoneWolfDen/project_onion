# Excel Parser — RAID/Status — PRD

## What it does
SheetJS browser parse, RAID 1 row=1 card, Weekly Status group by Project ID filter Client=Acme
...
## User Story
As a user with Client=Acme, Project=Apollo-123, I want excel parser — raid/status so I can get cards without scanning whole mailbox.
