# Anchor Service — Client/Project Onboarding — PRD

## What it does
Client Master dropdown PRIMARY filter, Project searchable, Opportunity regex, domains, people, Project Type
...
## User Story
As a user with Client=Acme, Project=Apollo-123, I want anchor service — client/project onboarding so I can get cards without scanning whole mailbox.
