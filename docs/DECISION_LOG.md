...
- Clarification: V6.3_ESC = doc card from file name PS-v2026.2a-Acme-Corp-(O-5030460)-V6.3_ESC - NOT laptop RAID log - laptop is timeline card Row12+Row18 Excel significance 0.9 EXTENSION Week33 - doc card is separate provenance from SharePoint file name containing O-5030460 - both linked to same anchor via opportunity_numbers + connected_record_ids + sharepoint_smps acmespf + gdp_ids 8399 - data/seed/cards.json now separates card_type timeline vs doc
